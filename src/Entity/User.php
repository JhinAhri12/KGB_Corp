...
class User implements UserInterface
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="date_création", type="datetime", nullable=false)
     */
    ...
    public function getDateCr��ation(): ?\DateTimeInterface
    {
        return $this->dateCr��ation;
    }

    public function setDateCr��ation(\DateTimeInterface $dateCr��ation): self
    {
